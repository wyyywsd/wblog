...
$(document).ready(function () {
    ...
    $("#index_unbind_page").html(function () {
            var a_h = ""
            //上一页
            if (currentPage == 1) {
                a_h = "<li  class=\"previous disabled\"><span><span aria-hidden=\"true\">&laquo;</span></span></li>"
            } else {
                a_h = "<li><a href=\"/batch/index/" + (currentPage - 1) + "\" style=\"cursor:pointer;\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>"
            }
            for (var i = 0; i < pageCount; i++) {
                var c = i + 1
                var a_active = "<li class = \"active\"><a class =\"unbind_page_a\" style=\"cursor:pointer;\" href=\"/batch/index/" + c + "\">" + c + "</a></li>"
                var a_previous = "<li class=\"previous disabled\"><span>...</span></li>"
                var a_normal = "<li><a class =\"unbind_page_a\" style=\"cursor:pointer;\" href=\"/batch/index/" + c + "\">" + c + "</a></li>"
            ...
            if (currentPage == pageCount) {
                ...
                a_h = a_h + "<li><a href=\"/batch/index/" + (currentPage + 1) + "\" style=\"cursor:pointer;\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li>"
            }
            return a_h
        }
    );
